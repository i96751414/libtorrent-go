...
FROM i96751414/cross-compiler-android-arm:${IMAGE_TAG}
...
ENV LT_CFLAGS -O2 -fPIC -DINT64_MAX=0x7fffffffffffffffLL -DINT16_MAX=32767 -DINT16_MIN=-32768 -DTORRENT_PRODUCTION_ASSERTS
